        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Label {
                    ...
                    font.pixelSize: 42; font.bold: true; color: window.colorTextMain
                    Layout.alignment: Qt.AlignHCenter
                }
                Label {
                    text: "ОСТАЛОСЬ"
                    font.pixelSize: 9; font.bold: true; color: window.colorTextLight
                ...
                Button {
                    ...
                    contentItem: Text {
                        text: parent.text; font.pixelSize: 10; font.bold: true
        ...
        RowLayout {
            ...
            Button {
                ...
                background: Rectangle {
                    ...
                    border.color: "#DCDCDC"; border.width: 1
                }
                contentItem: Text {
                ...
                onClicked: { root.currentStep--; root.updateStep(); }
            }
            ...
            Button {
                ...
                contentItem: Text {
                    text: parent.text; font.pixelSize: 12; font.bold: true; color: "white"
                    horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter
                }
                onClicked: {
